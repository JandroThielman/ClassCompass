...
<body>
    ...
    <?php
        ...
        if (isset($_POST['inloggen-docent'])) {
    ...
    <div class="inloggen-docent-div">
        ...
        <h1 class="inloggen-docent-tekst">Inloggen Docenten</h1>

        <form action="" method="post" class="form-inloggen-docent">

            <div class="user-div">
                <img src="./assets/user.svg" class="user">
                <input type="text" name="gebruikersnaam-docent" placeholder="gebruikersnaam" class="inloggen-docent-input">
            </div>
            ...
            <div class="wachtwoord-div">
                ...
                <input type="password" name="wachtwoord-docent" placeholder="wachtwoord" id="password" class="inloggen-docent-input">
                <img src="./assets/show-passw.svg" class="passw" id="passw" onclick="pass()">
            </div>
            
            <br>

            <input type="submit" name="inloggen-docent" value="Inloggen" class="inloggen-docent-button">
        </form>
